...
export const metadata = { title: "Privacy Policy — Campaign Monster" };
    ...
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <div className="space-y-8 text-gray-700">
        <section>
          ...
          <p>
            This policy explains what Campaign Monster (&quot;we&quot;,
            &quot;us&quot;) collects when you use Campaign Monster, and — because
            Campaign Monster is a tool for emailing your own contacts — it also
        ...
        <section>
          ...
          <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <li>Send the email addresses you upload to our verification provider to check deliverability</li>
            <li>Send the campaign emails you compose, through our sending provider, to the recipients you choose</li>
        ...
        <section>
          ...
          <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <li><strong>Our email verification provider</strong> — receives the email addresses you submit for verification</li>
            <li><strong>Our email delivery provider</strong> — sends the campaign emails you compose, and reports back bounces/complaints</li>
        ...
        <section>
          ...
          <p>
            ...
            you close your account, contact us at admin@campaign-monster.com and we&apos;ll
        ...
        <section>
          ...
          <p>
            ...
            data, or ask us to delete it, by writing to admin@campaign-monster.com.
          </p>
        </section>
        ...
        <section>
          ...
          <p>Questions about this policy: admin@campaign-monster.com · +1 410-670-0167 · Hyderabad, India.</p>
        </section>
      </div>
